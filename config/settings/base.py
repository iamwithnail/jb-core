...
LOCAL_APPS = [
    'jobsolutely.users.apps.UsersAppConfig',
    'core',
...
MIGRATION_MODULES = {
    'sites': 'jobsolutely.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'jobsolutely.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'jobsolutely.users.adapters.SocialAccountAdapter'
